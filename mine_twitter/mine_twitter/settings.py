...
CACHES = {
    'default': {
        ...
        'LOCATION': 'redis://127.0.0.1:6379/1',  # ajuste conforme necessário
        'OPTIONS': {
...
SIMPLE_JWT = {
    'ACCESS_TOKEN_LIFETIME': timedelta(days=365),  # Long duration for access token
    'REFRESH_TOKEN_LIFETIME': timedelta(days=365),  # Long duration for refresh token
